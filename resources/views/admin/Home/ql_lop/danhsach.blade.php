                    ...
                    <table class="table table-bordered">
                        <thead>
                          <tr style="background-color: rgb(247, 250, 67)">
                            ...
                            <th class="text-center text-primary">Mã lớp học</th>
                            <th class="text-center text-primary">Tên Lớp học</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="text-center text-primary"><a href="admin/lophoc/sua"><i class="fas fa-edit"></i></a></td>
